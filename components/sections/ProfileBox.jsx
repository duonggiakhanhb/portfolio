...
export default function ProfileBox({
    name = "Adam Nguyen",
    description = "Leader of APT team",
    headerText = "WE ARE HERE",
    numOfLikes = 25,
    ...
    ...props
      ...
      return (
        <div className="box">
            ...
            <img className="display-nft" src={image} alt="unsplash-OG44d93i-NJk" border={0} />
            <div className="infowrapper">
                <div className="info">
                <img className="info-img" src={profileImage} alt="unsplash-OG44d93i-NJk" border={0} />
                <div>
                    <p>{name}</p>
                    <p style={{color: '#92e8ff'}}>{description}</p>
                </div>
                </div>
                <div className="info2">
                <p>{headerText}</p>
